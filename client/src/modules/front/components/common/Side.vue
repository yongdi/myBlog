<template>
    <div class="sideBox">
        ...
        <div class="sideBox__main" :class="{ 'sideBox__main--open': sideBoxOpen}">
            ...
            <p class="sideBox__motto">
              <router-link :to="'/notettt/'" class="sideBox__motto">full stack engineer</router-link>
            </p>
            <p class="sideBox__motto">yongdi@qq.com</p>

            <input type="text" placeholder="搜索标题..." v-model="sTitle" @keyup.enter="$emit('ddoSearch', sTitle)">
